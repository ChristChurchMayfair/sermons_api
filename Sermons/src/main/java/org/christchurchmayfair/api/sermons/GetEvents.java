 ...
 */
public class GetEvents extends SermonDataFunction implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {

  public GetEvents() {
    super();
  }

  public GetEvents(SermonDataStore sermons) {
    super(sermons);
  }
  ...
  public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
    ...
    try {
      final List<Event> eventList = sermons.getEvents();
      final String sermonListAsString = objectMapper.writeValueAsString(eventList);
      ...
      e.printStackTrace();
      response.setBody("Problem listing events");
